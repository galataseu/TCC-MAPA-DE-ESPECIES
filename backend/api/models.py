...
class Animal(SoftDeleteModel):
    ...
    altura = models.FloatField(null=True, blank=True, help_text='Altura/comprimento em centímetros (cm)')
    peso = models.FloatField(null=True, blank=True, help_text='Peso em gramas (g)')
